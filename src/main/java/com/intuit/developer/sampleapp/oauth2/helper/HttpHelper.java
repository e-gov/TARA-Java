...
public class HttpHelper {
	...
	public HttpPost addHeader(HttpPost post) {
		String base64ClientIdSec = Base64.encodeBase64String((oAuth2Configuration.getClientId() + ":" + oAuth2Configuration.getClientSecret()).getBytes());
	...
	public List<NameValuePair> getUrlParameters(HttpSession session, String action) {
        ...
        if (action == "revoke") {
            ...
            urlParameters.add(new BasicNameValuePair("redirect_uri", oAuth2Configuration.getRedirectUri()));
